...
| A form of resource or advantage available and requires initial processing to be used on a broader industrial scale | The resource is shaped into components and products that serve building end user products |  | The end product to the true-user distributed at scale |
| :---- | :---- | :---- | :---- |
|  **Policy Tools:** Government influences sectors through policies that are implemented through a variety of tools: |  |  |  |
| Regulations and Legislations Government services Licensing and inspection regimes |  | Awareness campaigns Incentives and support programs Enforcement mechanisms |  |
